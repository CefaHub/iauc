...
public final class AuctionService {
    ...
    public enum Sort { CHEAP, NEW, OLD }
    ...
    public synchronized List<Listing> listPublic(Sort sort, String search) {
        ...
        Comparator<Listing> cmp = switch (sort) {
            case CHEAP -> Comparator.comparingDouble(l -> l.unitPrice);
            case NEW -> Comparator.comparingLong((Listing l) -> l.createdAtMs).reversed();
            case OLD -> Comparator.comparingLong(l -> l.createdAtMs);
        };
        out.sort(cmp);
        return out;
    }
